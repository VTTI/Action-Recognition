...
def main():
    ...
    cfg.data_root = '/vtti/qumulo01/FHWA/AE/scratch/FHWA_Secondary_Tasks_FolderCopy/train'
    cfg.data_root_val = '/vtti/qumulo01/FHWA/AE/scratch/FHWA_Secondary_Tasks_FolderCopy/val'
    cfg.ann_file_train = '/vtti/qumulo01/FHWA/AE/scratch/FHWA_Secondary_Tasks_FolderCopy/shrp2_train_video.txt'
    cfg.ann_file_val = '/vtti/qumulo01/FHWA/AE/scratch/FHWA_Secondary_Tasks_FolderCopy/shrp2_val_video.txt'
    cfg.ann_file_test = '/vtti/qumulo01/FHWA/AE/scratch/FHWA_Secondary_Tasks_FolderCopy/shrp2_val_video.txt'

    img_norm_cfg = dict(
    mean=[123.675, 116.28, 103.53], std=[58.395, 57.12, 57.375], to_bgr=False)

    cfg.data.test.type = 'VideoDataset'
    cfg.data.test.ann_file = '/vtti/qumulo01/FHWA/AE/scratch/FHWA_Secondary_Tasks_FolderCopy/shrp2_val_video.txt'
    cfg.data.test.data_prefix = '/vtti/qumulo01/FHWA/AE/scratch/FHWA_Secondary_Tasks_FolderCopy/val/'
    ...
    cfg.data.train.ann_file = '/vtti/qumulo01/FHWA/AE/scratch/FHWA_Secondary_Tasks_FolderCopy/shrp2_train_video.txt'
    cfg.data.train.data_prefix = '/vtti/qumulo01/FHWA/AE/scratch/FHWA_Secondary_Tasks_FolderCopy/train/'
    ...
    cfg.data.val.ann_file = '/vtti/qumulo01/FHWA/AE/scratch/FHWA_Secondary_Tasks_FolderCopy/shrp2_val_video.txt'
    cfg.data.val.data_prefix = '/vtti/qumulo01/FHWA/AE/scratch/FHWA_Secondary_Tasks_FolderCopy/val/'
    ...
    cfg.work_dir = '/vtti/qumulo01/FHWA/AE/scratch/FHWA_Secondary_Tasks_FolderCopy/workdir_tanet'
